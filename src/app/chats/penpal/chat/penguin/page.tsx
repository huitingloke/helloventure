...
export default function ChatPage() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      message: "hihi! guess we are penpals now!",
      sender: "Confused Penguin",
      image: ''
    },
    {
      message: "haha i guess we are! so how often do you travel?",
      sender: "Emily",
      image: ''
    },
    {
      message: "a lot actually! im a travel blogger by profession, hehe",
      sender: "Confused Penguin",
      image: ''
    },
    {
      message: "is that hard? wow.... i guess i should travel more",
      sender: "Emily",
      image: ''
    },
    {
      message: "nah, i love it! free food and stay and all i do is take videos? what a life :3",
      sender: "Confused Penguin",
      image: ''
    }
  ]);
