  ...
  const title = "Sakura Festival"
  const organizer = "Kuse Ryota"
  const new_link = "/chats/group/desc/sakura_fest"
  ...
  const users = [
    ["Jared Killney", "USA", "Male", "Hi, Emily! I like to listen to Taylor Swift. HBU?"],
    ["Amanda Lee", "Singapore", "Non-Binary", "yo girl sup"],
    ["Ruth Annabelle Lim", "Australia", "Female", "Yay! Someone else! Have you gotten a penpal yet?"],
    ["Poppy Lee-O", "Japan", "Male", "what's your favorite food?"],
  ]
